    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#dv_radio_eidt").change(function () {
                ...
                $.post("ManageRep.aspx", { param: 'name', id: sign }, function (data) {
        ...
        function Dell(id) {
            $.messager.confirm('删除报表', '你确定要删除该报表吗?', function (ok) {
                if (ok) {
                    $.post("ManageRep.aspx", { param: 'dellTable', id: id }, function (data) {
                        if (data.count == "1") {
        ...
        //添加报表名称
        function add() {
            $.post("ManageRep.aspx", { param: 'add', name: escape($("#txtTableName").val()), id: escape($("#txtId").val()), model: $("#mType").val() }, function (data) {
                if (data.count == "1") {
        ...
        function DellAttribute(key) {
            ...
            $.messager.confirm('删除报表', '你确定要删除该条数据吗?', function (ok) {
                if (ok) {
                    $.post("ManageRep.aspx", { param: 'Attribute', key: key
                    }, function (data) {
        ...
        function addSun() {
            ...
            $.post("ManageRep.aspx", { param: 'addSun', tid: escape($("#tbID").val()), tName: escape($("#tbName").val()), id: escape(pid)
            }, function (data) {
                if (data.count == "1") {
