        ...
        function InitTable() {
            $('#tableList').datagrid({
                ...
                columns: [[
                    ...
                    { field: 'REALTIME', title: '机组', width: 60, align: 'center' },
                    { field: 'DESC', title: '运行状态', width: 80, align: 'center' },
                    { field: 'TYPE', title: '负荷', width: 260, align: 'center' },
                    { field: 'SQL', title: '主汽流量', width: 80, align: 'center' },
                    { field: 'LEVE1', title: '主汽压力', width: 80, align: 'center' },
                    { field: 'LEVE2', title: '主汽温度', width: 80, align: 'center' },
                    { field: 'LEVE3', title: '再热温度', width: 80, align: 'center' },
                    { field: 'FLAG', title: '真空', width: 80, align: 'center' },
                    { field: 'FLAG', title: '锅炉效率', width: 80, align: 'center' },
                    { field: 'FLAG', title: '热耗', width: 80, align: 'center' },
                    { field: 'FLAG', title: '煤耗', width: 80, align: 'center' },
