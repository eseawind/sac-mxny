...
namespace SACSIS.Report
{
    public partial class ManageRep : System.Web.UI.Page
    {
        ...
        {
            bool judge = bll.DelTableAttributeByDigital(key, "T_BASE_HOURREPORT", "ID_KEY");
            if (judge)
                count = 1;
            object obj = new
            {
        ...
        private void AddSunInfo(string id, string tid, string tName)
        {
            ...
            _sql += "delete from T_BASE_HOURREPORT where T_PARAID is null or T_PARAID ='';";
            bool judge = false;// bll.AddSunInfo(name1, name2, name3, jz, order, unit, remark1, remark2, id, tid, tName);
